...
//      jdbcTemplate.update("INSERT INTO life_graph_data (id, parent_id, age, score,comment) VALUES (1, 2, 2 , 13 , 13, ffff)");
...
////    public String insertSample(Locale locale, Model model) {
//////        logger.info("Welcome insret! The client locale is {}.", locale);
////        jdbcTemplate.update("INSERT INTO prefectures (id, parent_id, age, score,comment) VALUES (1, 2, 2 , 13 , 13, ffff)");
//////        model.addAttribute("resultMessage", "登録完了");
//////        model.addAttribute("items", setSelectList());
////        return "dbAccessSample";
////    }
